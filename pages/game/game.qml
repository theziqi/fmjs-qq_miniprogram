<view class="container">
    <image src="../../static/3-tubiaobeijing.png" style="width: 750rpx;height: 1210rpx;position: absolute;top: 0;"></image>
    ...
    <view hidden="{{!(!isStartGame && !isEndGame)}}">
        ...
        <view class="gameRule">
            ...
            <view style="margin-top: 13rpx;">在两种发明中选择出现较早的那一种， 看看45s内你能答对多少道~</view>
